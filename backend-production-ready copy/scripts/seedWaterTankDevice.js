/**
 * سكربت إضافة حساس خزان المويه (Demo) في AllowedDevices
...
const WATER_TANK_DEVICE = {
  ...
  notes: 'Demo water tank sensor for investor presentation',
};
...
async function seed() {
  try {
    ...
    console.log('\n========================================');
    console.log('   Water Tank Sensor Registered!');
    console.log('========================================');
