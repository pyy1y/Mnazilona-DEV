/**
 * ═══════════════════════════════════════════════════════════════
 *  Manazel IoT - ESP32-C6 Firmware v1.0.0 (Device 2)
...
// ═══════════════════════════════════════
// CONFIG - الجهاز الثاني
// ═══════════════════════════════════════
#define SERIAL_NUMBER     "SN-002"
#define DEVICE_NAME       "Garage Relay 2"
#define DEVICE_SECRET     "f6e5d4c3b2a1f6e5d4c3b2a1f6e5d4c3"
...
// ═══════════════════════════════════════
// SoftAP Settings - اسم مختلف عشان ما يتعارض مع الجهاز الأول
// ═══════════════════════════════════════
